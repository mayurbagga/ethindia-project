...
export async function GET(request: Request) {
    try {
        ...
        const inchUrl = `https://api.1inch.dev/fusion/orders/v1.0/${chainId}/order/settlement`;
        ...
        return NextResponse.json({ message: 'Here is details of orders settlement !', data: response.data }, { status: 200 });
    } catch (error: any) {
