...
const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-md text-sm font-medium shadow ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'border border-input bg-primary  hover:bg-white hover:text-primary hover:border-black-600 text-white shadow-md',
        destructive:
          'h-56 w-auto border border-input bg-primary  hover:bg-white hover:text-primary hover:border-black-600 text-white shadow-md',
        outline:
